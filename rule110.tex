...
Research Institute\\\email{v.kharin@protonmail.com}}
    ...
    transactions and blocks. \knote{fix the following sentence: } 
    This in turn helps us to work around the halting problem, which is used to make 
    arbitrary script execution impossible inside a
    transaction in the view of the chain growth property. In our approach a single
    transaction is approximately corresponding to a single cycle of a computing 
    machine. The possible trade-off is between the consumed space and execution
    ...
    significantly optimized using richer language features, such as arithmetic
