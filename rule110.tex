...
%    sides~\cite{atzei2017survey,momot2016seven}.
    ...
    \begin{algorithm}[H]
        ...
        \begin{algorithmic}[1]
            \Function{\sf isRule110}{inLayer, outLayer}
            \Function{\sf calcBit}{$i$}
            \Let{$\ell$}{inLayer[$(i-1)$ \% (inLayer.size$-1$)]}
            \Let{$c$}{inLayer[$i$]}
            \Let{$r$}{inLayer[$(i+1)$ \% (inLayer.size$-1$)]}
    ...
    \begin{algorithm}[H]
        ...
        \begin{algorithmic}[1]
            \Function{\sf isRule110}{inLayer, outLayer}
            \Function{\sf calcBit}{$i$}
            \Let{$\ell$}{inLayer[$(i-1)$\Mod inLayer.size$-1$]}
            \Let{$c$}{inLayer[$i$]}
            \Let{$r$}{inLayer[$(i+1)$\Mod inLayer.size$-1$]}
            \State
    ...
    \begin{algorithm}[H]
        ...
        \begin{algorithmic}[1]
            ...
            \Let{$x$}{$\ell c r + cr + c + r$}
            \State
            \Return \Int($x == 1$ \Or $x == 3$)
            \EndFunction
            \State \Return outLayer == inLayer.indeces.map(calcBit)
            \EndFunction
            \vskip8pt
