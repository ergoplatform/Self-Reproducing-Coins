...
%    sides~\cite{atzei2017survey,momot2016seven}.
    ...
    For the description of Rule 110 implementation in a blockchain, we use
    ...
    is the one step Rule 110 transformation of the first argument.  In
    ...
    space and time. Particular implementation of this logic is provided in
    \nameref{appendix1}.
