...
Research Institute\\\email{v.kharin@protonmail.com}}
    ...
    In \nameref{appendix1} we describe the structure of general purpose guarding script
    ...
    of the blockchain while there is a strict upper-bound for block validation time. % перенес ссылку на GKL в первое место, где мы про это говорим
