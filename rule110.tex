...
\begin{document}
    ...
    loops. Their approach, while being successful in general, exposed few
    significant complications both from formal and security
    sides~\cite{momot2016seven,CVE201810705}. However, the main obstacles for
    the formal Turing completeness in the bolckchain, namely potentially
    infinite execution time, and potentially infinite storage memory, still
    persist.
    ...
    M.~Cook~\cite{cook2004universality}, who was able to use it to emulate the cyclic tag
    ...
    number of platforms avoiding usage of complicated ad--hoc structures.
