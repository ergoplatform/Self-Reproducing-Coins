...
\begin{document}
    ...
    example, in~\cite{miller2016ethereum} it was pointed that Turing--complete
    languages are fundamentally inappropriate for writing smart contracts as
    soon as their execution is halted after some bounded time.  \dnote{Listen to
    Andrew video to ensure, he was serious here}
...
%    sides~\cite{atzei2017survey,momot2016seven}.
    ...
    \nameref{appendix1} we provide the full implementation of the Rule
    ...
    \begin{figure}[h]
        ...
        \caption{Evolution of the cellular automaton described in
            ...
            Hatching indicates ``mid'' flag being set to $false$.
        \label{fig:bit_txs} }
    \end{figure}
